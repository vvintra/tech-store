...
export default function GamingPage() {
  ...
  const allGaming = getProductsByCategory("gaming")
  ...
  const filteredProducts = allGaming.filter((product) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Gaming</h1>
                <p className="text-gray-600 mt-1">
                  Descubre la mejor selección de Gaming ({allGaming.length} productos disponibles)
                </p>
              </div>
            </div>
          </div>
