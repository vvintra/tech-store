...
export default function AppleWatchPage() {
  ...
  const allAppleWatch = getProductsByCategory("apple-watch")
  ...
  const filteredProducts = allAppleWatch.filter((product) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Apple Watch</h1>
                <p className="text-gray-600 mt-1">
                  Descubre la mejor selección de Apple Watch ({allAppleWatch.length} productos disponibles)
                </p>
              </div>
            </div>
          </div>
