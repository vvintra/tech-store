...
export default function AudioPage() {
  ...
  const allAudio = getProductsByCategory("audio")
  ...
  const filteredProducts = allAudio.filter((product) => {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Descubre la mejor selección de Audio ({allAudio.length} productos disponibles)
                </p>
              </div>
            </div>
          </div>
